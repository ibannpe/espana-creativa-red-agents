// ABOUTME: Dialog component for creating new programs
...
import { useCreateProgramMutation } from '../hooks/mutations/useCreateProgramMutation'
import { createProgramRequestSchema, type CreateProgramRequest } from '../data/schemas/program.schema'

export function CreateProgramDialog() {
  const [open, setOpen] = useState(false)
  const { action: createProgram, isLoading } = useCreateProgramMutation()
